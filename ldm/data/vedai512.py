...
class VEDAIBase(Dataset):
    def __init__(self,
        ...
        self.labels = {
            ...
            "ir_file_path_": [os.path.join(self.ir_data_root, l.replace('co','ir'))
...
class VEDAITrain(VEDAIBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file="data/VEDAI512/train.txt", 
                         data_root="/public/home/maofangyuan/dataset/VEDAI/VEDAI_512/train", 
                         **kwargs)


class VEDAIVal(VEDAIBase):
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(txt_file="data/VEDAI512/test.txt", 
                         data_root="/public/home/maofangyuan/dataset/VEDAI/VEDAI_512/test",
